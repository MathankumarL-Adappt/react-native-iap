 ...
 * @returns {Promise<string>}
 */
export var validateLicence = function () {
    return Platform.select({
        android: function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!RNIapModule) {
                ...
                return [2 /*return*/, RNIapModule.validateLicence()];
            });
        }); },
    })();
};
 ...
 */
export var finishTransaction = function (transactionId, isConsumable, developerPayloadAndroid) {
    return Platform.select({
        ios: function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                checkNativeiOSAvailable();
        ...
        android: function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (isConsumable) {
                    return [2 /*return*/, RNIapModule.consumeProduct(transactionId, developerPayloadAndroid)];
                }
                return [2 /*return*/, RNIapModule.acknowledgePurchase(transactionId, developerPayloadAndroid)];
            });
        }); },
    })();
};
